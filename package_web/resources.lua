...
return module(function (resources)
	...
	function resources.load_spritesheet(basepath, name, prefix)
		...
		-- data is an embedded function that is run without a sandbox using some global functions
		
		rawset(_G, 'sheet', function (filename, width, height, image_list)
		...
		rawset(_G, 'clip', function (name, frames)
