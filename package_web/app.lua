...
return class(function (app)
	...
	function app.launch(reference_screen_size, asset_scales, initial_scene)
		...
		function love.mousepressed(x, y, button, is_touch)
			...
			if not is_touch and (tonumber(button) == 1 or button == 'l') then
		...
		function love.load()
			...
			app = app(reference_screen_size, asset_scales, initial_scene)
	...
	function app:render(renderer)
		if love.graphics and (not love.graphics.isActive or love.graphics.isActive()) then
